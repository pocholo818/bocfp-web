    ...
    <ion-header>
      <ion-toolbar style="">
        <ion-buttons slot="start">
          <ion-back-button text="Back" defaultHref="/guardian"></ion-back-button>
        </ion-buttons>
      </ion-toolbar>
    </ion-header>
                ...
                <ion-item v-for="child in childData" :key="child.id">
                  <ion-label>
                    ...
                    <ion-button color="danger" @click="link_delete(child.link_id)"><ion-icon
                        :icon="trashOutline"></ion-icon>Del<span class="hide-on-mobile abbreviation">ete</span>&nbsp;Link</ion-button>
                  </ion-label>
                </ion-item>
              </div>
